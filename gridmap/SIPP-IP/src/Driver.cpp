...
int main(int argc, char** argv)
{
	...
	desc.add_options()
		...
		// ("map,m", po::value<string>()->default_value("random-128-128-20.map"), "input file for map")
		// ("agents,a", po::value<string>()->default_value("random-128-128-20-random-1.scen"), "input file for agents")
		...
		// ("map,m", po::value<string>()->default_value("./data/empty-16-16/empty-16-16.map"), "input file for map")
		// ("agents,a", po::value<string>()->default_value("./data/empty-16-16/scen-random/empty-16-16-random-7.scen"), "input file for agents")

		// ("map,m", po::value<string>()->default_value("./data/empty-32-32/empty-32-32.map"), "input file for map")
		// ("agents,a", po::value<string>()->default_value("./data/empty-32-32/scen-random/empty-32-32-random-7.scen"), "input file for agents")
		
		// ("map,m", po::value<string>()->default_value("./data/random-64-64/random-64-64-10.map"), "input file for map")
		// ("agents,a", po::value<string>()->default_value("./data/random-64-64/scen-random/random-64-64-10-random-1.scen"), 
		// 	"input file for agents")

		// ("map,m", po::value<string>()->default_value("./data/warehouse-10-20-10-2-1/warehouse-10-20-10-2-1.map"), "input file for map")
		// ("agents,a", po::value<string>()->default_value("./data/warehouse-10-20-10-2-1/scen-random/warehouse-10-20-10-2-1-random-1.scen"), 
		// 	"input file for agents")
